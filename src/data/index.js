...
const experiences = [
  {
    ...
    company_name: "Utah Tech University",
    date: "2016 - Present",
    details: [
...
const portfolio = [
  {
    name: "UDP Repeater Service",
    description:
      `A Microsoft Service that listens for packets on a raw socket, extracts their payloads, 
      and sends the payload out to a user-specified endpoint. Also includes a WinForms GUI 
      Front End for statistics and configuration, a bootstrapped Wix Toolset installer, and 
      metric/log exporting through a Prometheus/Loki/Grafana monitoring stack.`,
    image: oscs,
  },
  {
    name: "Dev Notes",
